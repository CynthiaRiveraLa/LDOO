...
/** /* Cynthia Elizabeth Rivera Laguna 1728227 Practica 3 */
 *
 * @author eliza
 */
public class Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
         ...
         try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<p>Año de nacimiento: <input type=\"number\" name=\"nacido\" min=\"1940\" max=\"2099\" /></p>");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
                    ...
                    out.println("La contraseña es: "+contraseña);
                    out.println("El año de nacimiento es: "+nacido);
